...
public class VehicleData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vehicle's Insert");
    ...
    private void AddVehicle(Validation validation) throws HeadlessException, NumberFormatException {
        ...
        try (MongoClient mongoClient = MongoClients.create(uri)) {
            ...
            if (validation.validateInt(txtId.getText())) {
                ...
                if (validation.ValidateLetterStringWithSpaces(txtCarType.getText())) {
                    validate = true;
            ...
            if (validate) {
                Document doc1 = new Document("Id", id).append("Name", carType).append("Ammount", amount).append("Price", price);
