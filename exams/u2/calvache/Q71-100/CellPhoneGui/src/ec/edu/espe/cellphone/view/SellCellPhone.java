 ...
 */
public class SellCellPhone extends javax.swing.JFrame {
     ...
     */
    public SellCellPhone() {
        initComponents();
        mongoDBConnection = new MongoDBConection("Cellphone");
    ...
    private void calculateTotalPrice() {
        try {
            ...
            if (document != null) {
                ...
                JOptionPane.showMessageDialog(this, "That CellPhone id doesn't exist");
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sell CellPhone");

        jLabel2.setText("Enter Id to search");

        jLabel3.setText("CellPhone Price");
    ...
    private void btnReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReturnActionPerformed
        CellPhoneGui cellPhoneGui=new CellPhoneGui();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SellCellPhone.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SellCellPhone().setVisible(true);
            }
        });
    }
