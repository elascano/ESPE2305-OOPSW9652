 ...
 */
public class Alpaca extends FarmAnimal implements iWool{
    
    private Date lastSheering;
    private float woolDistance;

    public Alpaca(Date lastSheering, float woolDistance, int id, String breed, Date bornOn) {
    ...
    public String toString() {
        return "Alpaca: " + super.toString() + ", lastSheering: " + lastSheering + ", woolDistance: " + woolDistance + " meters";
    }
