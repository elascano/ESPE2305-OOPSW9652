...
Contact contact;
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        int option= JOptionPane.showConfirmDialog(this, "Are you ure to save\n " + contact.getFullName());
        if(option==0){
            JOptionPane.showMessageDialog(rootPane, "saved" + contact.toString());
            emptyFields();
        }
        if( option==1){
        ...
        emptyFields();
        //call to database controller or library for save contact
    ...
    private Contact readContact() throws NumberFormatException {
        Contact contact;
        int id;
        String fullName;
        String contactName;
        String phoneNumber="0987654321"; //int
        String email;
        String gender="male";
        String type="family";
